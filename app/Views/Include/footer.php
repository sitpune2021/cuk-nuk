...
<div class="footer footer-7 ftr-bg-black">
    <div class="footer-top clearfix">
        <div class="container container-1330">
            <div class="row justify-content-between gx-4">
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-4 footer-instagram d-flex flex-column align-items-center text-center">
                    <a class="logoImg" href="<?= base_url(); ?>">
                        <img src="<?= base_url(); ?>public/assets/images/logo.png" alt="Cuknuk" title="Cuknuk" width="100" height="30" />
                    </a>
                    <div class="mt-2 col-lg-10 text-justify">
                        We provide the finest quality of products to our consumers and incorporate the best and reliable
                        frozen technology to enrich the food industry. We look forward to continue to enhance the
                        freshness and nutrients in our every offering.
                    </div>
                </div>

                <!-- Information Section -->
                <div class="col-12 col-sm-12 col-md-4 col-lg-2 d-flex flex-column align-items-start new">
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-4 footer-contact d-flex flex-column align-items-start new">
                    <h4 class="h4">Contact Info</h4>
                    <p class="phone d-flex align-items-center">
                        <i class="icon anm anm-phone-l me-2" style="font-weight: bold;"></i>
                        <b class="fw-400">Toll Free</b> <a href="tel:9823777232">(+91) 9823777232</a>
                    </p>
                    <p class="email d-flex align-items-center">
                        <i class="icon anm anm-envelope-l me-2" style="font-weight: bold;"></i>
                        <a href="mailto:sales@cuknuk.in">sales@cuknuk.in</a>
                    </p>
                    <p class="address d-flex">
                        <i class="icon anm anm-map-marker-al me-2 pt-1" style="font-weight: bold;"></i>
                        Sr.No.78, Pandhari Industrial Estate, Shivane, Pune, Maharashtra, India - 411023
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="footer-bottom clearfix">
        <div class="container container-1330">
            <div class="row align-items-center justify-content-between"  style="margin-left:22px;">
                <!-- Social Icons -->
                <ul class="list-inline social-icons d-inline-flex align-items-center justify-content-center col-12 col-sm-4 col-lg-1">
                    ...
                    <li class="list-inline-item"><a href="https://wa.me/9823777232" data-bs-toggle="tooltip" data-bs-placement="top" title="WhatsApp"><i class="icon anm anm-whatsapp" style="font-weight: bold;"></i></a></li>
                </ul>

                <!-- Copy Text -->
                <div class="copytext col-12 col-md-12 col-lg-11 text-center text-lg-start">
                    &copy; 2024 CukNuk. All Rights Reserved. Design & Developed by SIT Solutions Pvt. Ltd
                </div>
            </div>
        </div>
    </div>
            ...
            <ul class="m-0 clearfix">
                ...
                <li class="item d-flex justify-content-center align-items-center">
                    ...
                    <a class="product-image rounded-4" href="product-layout1.html">
                        ...
                        <img class="rounded-4 blur-up lazyload"
                            data-src="<?= base_url(); ?>public/assets/images/products/cart-vegetables-product-img1.jpg"
                            src="<?= base_url(); ?>public/assets/images/products/cart-vegetables-product-img1.jpg"
                ...
                <li class="item d-flex justify-content-center align-items-center">
                    ...
                    <a class="product-image rounded-4" href="product-layout1.html">
                        ...
                        <img class="rounded-4 blur-up lazyload"
                            data-src="<?= base_url(); ?>public/assets/images/products/cart-vegetables-product-img2.jpg"
                            src="<?= base_url(); ?>public/assets/images/products/cart-vegetables-product-img2.jpg"
                            alt="product" title="Product" width="120" height="170" />
        ...
        <div class="minicart-bottom">
            ...
            <div class="shipinfo">
                ...
                <div class="freeShipMsg"><i class="icon anm anm-truck-l fs-6 me-2 align-middle"></i>Only <span
                        class="money" data-currency-usd="$199.00" data-currency="USD">$199.00</span> away from <b>Free
                        Shipping</b></div>

                <div class="freeShipMsg d-none"><i class="icon anm anm-truck-l fs-6 me-2 align-middle"></i>Congrats! You
                    are eligible for <b>Free Shipping</b></div>
                ...
                <form method="post" action="#" id="product-form-quickshop" class="product-form align-items-center">
                    ...
                    <div class="row g-0 item mb-3">
                        ...
                        <a class="col-4 product-image" href="product-layout1.html"><img
                                class="rounded-4 blur-up lazyload"
                                data-src="<?= base_url(); ?>public/assets/images/products/vegetables-product3.jpg"
                                src="<?= base_url(); ?>public/assets/images/products/vegetables-product3.jpg"
                                alt="Product" title="Product" width="400" height="400" /></a>
                    ...
                    <div class="variants-clr swatches-image clearfix mb-3 swatch-0 option1" data-option-index="0">
                        ...
                        <ul class="swatches d-flex-justify-center pt-1 clearfix">
                            ...
                            <li class="swatch large rounded available active"><img
                                    src="<?= base_url(); ?>public/assets/images/products/swatches/blue-red.jpg"
                                    alt="image" width="70" height="70" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="Blue" /></li>

                            <li class="swatch large rounded available"><img
                                    src="<?= base_url(); ?>public/assets/images/products/swatches/blue-red.jpg"
                                    alt="image" width="70" height="70" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="Black" /></li>
                            ...
                            <li class="swatch large rounded available green"><span class="swatchLbl"
                                    data-bs-toggle="tooltip" data-bs-placement="top" title="Green"></span></li>

                            <li class="swatch large rounded soldout yellow"><span class="swatchLbl"
                    ...
                    <div class="variants-size swatches-size clearfix mb-4 swatch-1 option2" data-option-index="1">
                        ...
                        <ul class="size-swatches d-flex-justify-center pt-1 clearfix">
                            ...
                            <li class="swatch large rounded soldout"><span class="swatchLbl" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="XS">XS</span></li>

                            <li class="swatch large rounded available active"><span class="swatchLbl"
                                    data-bs-toggle="tooltip" data-bs-placement="top" title="S">S</span></li>

                            <li class="swatch large rounded available"><span class="swatchLbl" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="M">M</span></li>

                            <li class="swatch large rounded available"><span class="swatchLbl" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="L">L</span></li>

                            <li class="swatch large rounded available"><span class="swatchLbl" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="XL">XL</span></li>
                    ...
                    <div class="product-form-submit d-flex-justify-center">
                        ...
                        <button type="submit" name="add"
                            class="btn btn-primary rounded-pill product-cart-submit me-2"><span>Add to
                                cart</span></button>

                        <button type="submit" name="sold" class="btn btn-secondary rounded-pill product-sold-out d-none"
                            disabled="disabled">Sold out</button>

                        <button type="submit" name="buy" class="btn btn-secondary rounded-pill proceed-to-checkout">Buy
                            it now</button>
                    ...
                    <div class="text-center mt-3"><a class="text-link" href="product-layout1.html">View More Details</a>
                    </div>
                ...
                <form method="post" action="#" id="product-form-addtocart" class="product-form align-items-center">
                    ...
                    <div class="row d-flex-center text-center">
                        ...
                        <div class="col-md-6">
                            ...
                            <a class="product-image" href="product-layout1.html"><img class="rounded-4 blur-up lazyload"
                                    data-src="<?= base_url(); ?>public/assets/images/products/vegetables-product4.jpg"
                                    src="<?= base_url(); ?>public/assets/images/products/vegetables-product4.jpg"
                                    alt="Product" title="Product" width="400" height="400" /></a>
                        ...
                        <div class="col-md-6 mt-3 mt-md-0">
                            ...
                            <div class="addcart-total rounded-5">
                                ...
                                <p class="d-flex-justify-center">Total: <span class="price text-primary">$198.00</span>
                                </p>
                            ...
                            <div class="product-form-submit d-flex-justify-center">
                                ...
                                <a href="#" class="btn btn-outline-primary rounded-pill product-continue w-100">Continue
                                    Shopping</a>

                                <a href="cart-style1.html"
                                    class="btn btn-secondary rounded-pill product-viewcart w-100 my-2 my-md-3">View
                                    Cart</a>

                                <a href="checkout-style1.html"
                                    class="btn btn-primary rounded-pill product-checkout w-100">Proceed to checkout</a>
                        ...
                        <div id="quickView" class="carousel slide">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="item carousel-item active" data-bs-slide-number="0">
                                    ...
                                    <img class="rounded-4 blur-up lazyload"
                                        data-src="<?= base_url(); ?>public/assets/images/products/vegetables-product1.jpg"
                                        src="<?= base_url(); ?>public/assets/images/products/vegetables-product1.jpg"
                                        alt="product" title="Product" width="400" height="400" />
                                ...
                                <div class="item carousel-item" data-bs-slide-number="1">
                                    ...
                                    <img class="rounded-4 blur-up lazyload"
                                        data-src="<?= base_url(); ?>public/assets/images/products/vegetables-product2.jpg"
                                        src="<?= base_url(); ?>public/assets/images/products/vegetables-product2.jpg"
                                        alt="product" title="Product" width="400" height="400" />
                                ...
                                <div class="item carousel-item" data-bs-slide-number="4">
                                    ...
                                    <img class="rounded-4 blur-up lazyload"
                                        data-src="<?= base_url(); ?>public/assets/images/products/vegetables-product5.jpg"
                                        src="<?= base_url(); ?>public/assets/images/products/vegetables-product5.jpg"
                                        alt="product" title="Product" width="400" height="400" />
                                ...
                                <div class="item carousel-item" data-bs-slide-number="5">
                                    ...
                                    <img class="rounded-4 blur-up lazyload"
                                        data-src="<?= base_url(); ?>public/assets/images/products/vegetables-product6.jpg"
                                        src="<?= base_url(); ?>public/assets/images/products/vegetables-product6.jpg"
                                        alt="product" title="Product" width="400" height="400" />
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                        ...
                        <div class="pro-stockLbl my-2">
                            ...
                            <span class="d-flex-center stockLbl instock d-none"><i
                                    class="icon anm anm-check-cil text-primary"></i><span> In stock</span></span>

                            <span class="d-flex-center stockLbl preorder d-none"><i
                                    class="icon anm anm-clock-r text-primary"></i><span> Pre-order Now</span></span>

                            <span class="d-flex-center stockLbl outstock d-none"><i
                                    class="icon anm anm-times-cil text-primary"></i> <span>Sold out</span></span>

                            <span class="d-flex-center stockLbl lowstock" data-qty="15"><i
                                    class="icon anm anm-exclamation-cir text-primary"></i><span> Order now, Only <span
                                        class="items text-primary">10</span> left!</span></span>
                            ...
                            <div class="product-options d-flex-wrap">
                                ...
                                <div class="product-item swatches-size w-100 mb-3 swatch-1 option2"
                                    ...
                                    <ul class="variants-size size-swatches d-flex-center pt-1 clearfix">
                                        ...
                                        <li class="swatch large rounded soldout"><span class="swatchLbl"
                                        ...
                                        <li class="swatch large rounded available"><span class="swatchLbl"
                                ...
                                <div class="product-action d-flex-wrap w-100 pt-1 mb-3 clearfix">
                                    ...
                                    <div class="quantity">
                                        ...
                                        <div class="qtyField rounded">
                                            ...
                                            <input type="text" name="quantity" value="1"
                                                class="product-form__input qty rounded-pill">
                                    ...
                                    <div class="addtocart ms-3 fl-1">
                                        ...
                                        <button type="submit" name="add"
                                            class="btn btn-primary rounded-pill product-cart-submit w-100"><i
                                                class="icon anm anm-basket-l me-2"></i><span>Add to cart</span></button>

                                        <button type="submit" name="sold"
                                            class="btn btn-secondary rounded-pill product-sold-out w-100 d-none"
                                            disabled="disabled"><span>Sold out</span></button>

                                        <button type="submit" name="buy"
                                            class="btn btn-secondary rounded-pill proceed-to-checkout w-100 d-none"><span>Buy
                                                it now</span></button>
                        ...
                        <div class="wishlist-btn d-flex-center">
                            ...
                            <a class="add-compare d-flex-center" href="compare-style1.html" title="Add to Compare"><i
                                    class="icon anm anm-random-r me-2"></i> <span>Add to Compare</span></a>
                        ...
                        <div class="social-sharing share-icon d-flex-center mx-0 mt-3">
                            ...
                            <a href="#" class="d-flex-center btn btn-link btn--share share-email"
                                data-bs-toggle="tooltip" data-bs-placement="top" title="Share by Email"><i
                                    class="icon anm anm-whatsapp"></i><span class="share-title d-none">Email</span></a>
