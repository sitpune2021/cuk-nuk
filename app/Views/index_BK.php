                                    ...
                                    <div class="product-image">
                                       <a href="<?=base_url();?>productDetails?per=<?=$row['permalink'];?>" class="product-img rounded-4">
                                        <?php if (!empty($row['image'])) { ?>
                                            <img class="primary rounded-4 blur-up lazyload" data-src="<?=base_url();?>public/Admin/assets/images/Product_images/<?=$row['image'];?>" src="<?=base_url();?>public/assets/images/products/vegetables-product1.jpg" alt="Product" title="Product" width="400" height="400" />
                                            <img class="hover rounded-4 blur-up lazyload" data-src="<?=base_url();?>public/Admin/assets/images/Product_images/<?=$row['image'];?>" src="<?=base_url();?>public/assets/images/products/vegetables-product1-1.jpg" alt="Product" title="Product" width="400" height="400" />
                                        <?php } ?>
                                        </a>
                                    </div>
                                ...
                                <div class="collection-banner-item mb-3 mb-md-0">
                                    <div class="row sp-row row-cols-lg-1 row-cols-md-1 row-cols-sm-1 row-cols-1">
                                        <div class="collection-item sp-col large-bnr ctImg1">
                                            <a href="shop-left-sidebar.html" class="bg-square-hv rounded-4 clr-none">
                                                <div class="img">
                                ...
                                <div class="collection-banner-item">
                                    <div class="row sp-row row-cols-lg-2 row-cols-md-2 row-cols-sm-2 row-cols-2">
                                        <div class="collection-item sp-col sale-banner ctImg2">
                                            <a href="shop-left-sidebar.html" class="zoom-scal rounded-4 clr-none">
                                                <div class="img">
                        ...
                        <div class="tabs-listing">
                            <ul class="nav nav-tabs style1 justify-content-center" id="productTabs" role="tablist">
                                <?php 
                                    ...
                                    $categoryId = $cat['id'];   
                                    $db = db_connect('default');
                                    $query = $db->query("SELECT * FROM `tbl_product` WHERE product_type=$categoryId ");
                                    $data = $query->getResultArray();
                                ?>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link text-uppercase active body-font" id="<?=$cat['id'];?>-tab" data-bs-toggle="tab" data-bs-target="#<?=$cat['id'];?>" type="button" role="tab" aria-controls="<?=$cat['id'];?>" aria-selected="true"><?=$cat['category_name'];?></button>
                                </li>
                            <?php } ?>
                            </ul>
                            ...
                            <?php  $counter=0; foreach($catD as $cat){ ?>
                                <div class="tab-pane show <?php echo $counter === 0 ? 'active' : ''; ?>" id="<?=$cat['id'];?>" role="tabpanel" aria-labelledby="<?=$cat['category_name'];?>-tab">
                                    <!--Product Grid-->
                                        ...
                                        <div class="grid-products pro-hover3 row col-row row-cols-lg-4 row-cols-md-3 row-cols-sm-3 row-cols-2">                                           
                                            <div class="item col-item">
                                                <div class="product-box">
                                                    ...
                                                    <div class="product-image">
                                                        <!-- Start Product Image -->
                                                        <a href="product-layout1.html" class="product-img rounded-4">
                                                            <!-- Image -->
                                                            <img class="primary rounded-4 blur-up lazyload" data-src="<?=base_url();?>public/assets/images/products/vegetables-product2.jpg" src="<?=base_url();?>public/assets/images/products/vegetables-product2.jpg" alt="Product" title="Product" width="400" height="400" />
                                                            <!-- End Image -->
                                                            <!-- Hover Image -->
                                                            <img class="hover rounded-4 blur-up lazyload" data-src="<?=base_url();?>public/assets/images/products/vegetables-product2-1.jpg" src="<?=base_url();?>public/assets/images/products/vegetables-product2-1.jpg" alt="Product" title="Product" width="400" height="400" />
                                                            <!-- End Hover Image -->
                                                        </a>
                                                        <!-- End Product Image -->                                                       
                                                    </div>
                                                    ...
                                                    <div class="product-details text-left">
                                                        ...
                                                        <div class="product-name-price">
                                                            <!-- Product Name -->
                                                            <div class="product-name">
                                                                <a href="product-layout1.html">Organic Potatos</a>
                                                            </div>
                                                            <!-- End Product Name -->
                                                            <!-- Product Price -->
                                                        ...
                                                        <div class="button-bottom-action style1">
                                                            <div class="button-left">
                                                                <!--Cart Button-->
                                                                <a href="#quickshop_modal" class="btn btn-primary btn-md rounded-pill addtocart quick-shop-modal" data-bs-toggle="modal" data-bs-target="#quickshop_modal">
                    ...
                    <div class="container container-1330">
                        ...
                        <?php foreach($categoryD as $row){ ?>
                            <div class="category-item zoomscal-hov rounded-4">
                                <a href="<?=base_url();?>P?per=<?=$row['permalink'];?>" class="category-link clr-none">
                                    <?php if (!empty($row['image'])) { ?>
                                    ...
                                    <div class="details mt-3 pt-1 text-center">
                                        <h4 class="category-title mb-0 body-font" style="min-height:20px;max-height:20px;"><?=$row['category_name'];?></h4>
                                    </div>
                                </a>
                            </div>
                        <?php } ?>
